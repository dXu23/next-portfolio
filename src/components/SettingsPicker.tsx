...
export default function SettingsPicker({ hidden }: { hidden: boolean }) {
  ...
  const selectedThemeStyler = (theme: string) => ({
    border:
      settings.theme === theme ? "1px solid var(--text-primary)" : "initial",
  });

  return (
    <div
      className={
        `${styles.settingsPicker} visibility-anim` +
        `${hidden ? " hidden" : ""}`
      }
    >
      <div className={styles.themeSettings}>
        <label
          ...
          style={selectedThemeStyler("default")}
        >
          <input
            name="theme"
            type="radio"
        ...
        <label
          className={styles.themeSetting}
          style={selectedThemeStyler("tomorrow")}
        >
          <input
            name="theme"
            type="radio"
        ...
        <label
          className={styles.themeSetting}
          style={selectedThemeStyler("gruvbox")}
        >
          <input
            name="theme"
            type="radio"
        ...
        <label
          className={styles.themeSetting}
          style={selectedThemeStyler("solarized")}
        >
          <input
            name="theme"
            type="radio"
        ...
        <label
          className={styles.themeSetting}
          style={selectedThemeStyler("material")}
        >
          <input
            name="theme"
            type="radio"
