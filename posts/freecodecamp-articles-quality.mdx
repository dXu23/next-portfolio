...
As explained in this article [Legitimate Use of Variable Length Arrays]
(https://nullprogram.com/blog/2019/10/27/), variable length arrays (VLAs)
are usually bad practice. Most of the time, it is better to use std::vector
instead:
...
About a couple of weeks ago, I read an article titled [How to Build Your Own 
...
method in Javascript [**creates a new array**]
(https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map),
and Array.prototype.sort [**sorts the elements of an array in place**]
